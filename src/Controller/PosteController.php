...
final class PosteController extends AbstractController
{
    ...
    public function index(PosteRepository $posteRepository): Response
    {
        return $this->render('poste/index.html.twig', [
            'postes' => $posteRepository->findAllPosteDTOs(),
        ]);
    }

    #[Route('/creation', name: 'app_poste_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash("success", "Nouveau poste créé avec succès");
    ...
    #[Route('/{id}/modifier', name: 'app_poste_edit', methods: ['GET', 'POST'])]
