...
final class DepartementController extends AbstractController
{
    ...
    public function index(DepartementRepository $departementRepository): Response
    {
        return $this->render('departement/index.html.twig', [
            'departements' => $departementRepository->findAllWithEmployeeCount(),
        ]);
    }

    #[Route('/nouveau', name: 'app_departement_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}/modifier', name: 'app_departement_edit', methods: ['GET', 'POST'])]
